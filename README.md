...
Use our [colab notebook](colab/music_transcription_with_transformers.ipynb) to
transcribe WAV files of your choosing.  You can use a pretrained checkpoint from
